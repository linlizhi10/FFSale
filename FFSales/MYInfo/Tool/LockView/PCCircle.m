...
- (UIColor *)outCircleColor
{
    ...
    switch (self.state) {
        ...
        case CircleStateSelected:
            color = [PCCircleViewConst getCircleStateSelectedOutsideColor];
            if (_type == CircleTypeInfo) {
...
//            color = CircleStateSelectedInsideColor;
            color = [PCCircleViewConst getCircleStateSelectedInsideColorType:_type];
...
//            color = CircleStateSelectedInsideColor;
        ...
        default:
            color = CircleStateNormalInsideColor;
            if (_type == CircleTypeInfo) {
                color = CricleStateNormalInsideColorInfo;
            }
            break;
    }
    return color;
...
//            color = CircleStateSelectedTrangleColor;
            color = [PCCircleViewConst getCircleStateSelectedTrangleColor];
            break;
        case CircleStateError:
