 ...
 *  普通状态下外空心圆颜色
 */
#define CircleStateNormalOutsideColor RGBCOLORV(0x999999)
...
/*
 小展示用内实心圆普通状态颜色
 */
#define CricleStateNormalInsideColorInfo RGBCOLORV(0xdbdbdb)
/**
 *  错误状态内实心圆颜色
 */
 ...
 *  普通状态下文字提示的颜色
 */
#define textColorNormalState RGBCOLORV(0x999999)
...
+ (UIColor *)getCircleStateSelectedInsideColorType:(CircleType)typea;
